...
echo -b "AUTHOR    : HACKER INGUSAN $green " |lolcat
...
sleep 1
echo -b $green"[#]> HACKER INGUSAN On Your System" |lolcat
...
00) echo "AUTHOR: HACKER INGUSAN" | lolcat
echo "HACKER INGUSAN ON YOUR SYSTEM" | lolcat
